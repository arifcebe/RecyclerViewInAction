 ...
 */
public class LinearVerticalAdapter
    extends RecyclerView.Adapter<LinearVerticalAdapter.LinearHolder> {

  private Context context;
  private List<Mountain> mountainList;

  public LinearVerticalAdapter(Context context, List<Mountain> mountainList) {
